...
interface HmsMotionImageProcessor {
    fun process(data: ByteBuffer?, frameMetadata: FrameMetadata?, graphicOverlay: BoneGLSurfaceView)
    fun process(bitmap: Bitmap?, graphicOverlay: BoneGLSurfaceView)
    fun stop()
}